    ...
    <footer className="bg-dark text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-2xl font-bold font-display mb-4">
              FESTIVO <span className="text-primary">2025</span>
            </h3>
            <p className="text-gray-300 mb-4">
              The biggest cultural and technical fest of the year. Join us for three days of excitement, innovation, and entertainment.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>© {currentYear} Festivo 2025. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
